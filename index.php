        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <input class="form-control me-2 bt-field" type="search" placeholder="Введите поле" aria-label="Search" id="search">
                    ...
                    <button class="btn btn-primary bt-btn-search" type="submit-reg" id="search-btn">Поиск перебором</button>
                    <button class="btn btn-success bt-btn-search" type="submit-bt" id="search-index-btn">Индексный поиск</button>
                    <button class="btn btn-danger bt-btn-search" type="submit-bt" id="search-all-btn">Показать все</button>
